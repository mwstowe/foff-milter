...
fn main() {
    ...
    headers.insert("authentication-results".to_string(), 
        "juliett.baddomain.com; dkim=fail reason=\"key not found in DNS\" (0-bit key; unprotected) header.d=ml.fleetlogisticstrucks.site header.i=catili@ml.fleetlogisticstrucks.site header.b=l9fB3a0+".to_string());
    ...
    let recipients = vec!["mstowe@baddomain.com"];
