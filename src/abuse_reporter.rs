...
impl AbuseReporter {
    ...
    fn generate_abuse_report(
        ...
        report.push_str("Generated by: FOFF Milter (https://github.com/mwstowe/foff-milter)\n");
...
mod tests {
    ...
    async fn test_abuse_report_generation() {
        ...
        let context = MailContext {
            sender: Some("bounces+55266851-93ca-marcy=example.com@sendgrid.net".to_string()),
