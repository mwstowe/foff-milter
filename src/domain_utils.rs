...
mod tests {
    ...
    fn test_extract_domain() {
        assert_eq!(DomainUtils::extract_domain("user@example.com"), Some("example.com".to_string()));
    ...
    fn test_canonicalize_domain() {
        assert_eq!(DomainUtils::canonicalize_domain("www.example.com"), "example.com");
        assert_eq!(DomainUtils::canonicalize_domain("example.com"), "example.com");
    }
}
