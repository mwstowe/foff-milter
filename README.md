...
Automatically report abuse of legitimate email services (SendGrid, Mailchimp, etc.) to the service providers:
...
**Note**: Currently logs abuse reports for manual submission. In production, this could be extended to automatically send reports via email or HTTP APIs.

See `examples/sendgrid-abuse-reporting.yaml` for comprehensive abuse reporting configuration examples.
